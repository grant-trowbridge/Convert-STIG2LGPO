...
> [!IMPORTANT]
> This tool is intended for **nondomain-joined systems**. Domain-joined systems, by nature, should receive group policy configurations from Group Policy Objects (GPOs) stored on the system's respective Active Directory Domain Controller.
